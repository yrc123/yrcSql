...
table.render({
	...
	cols:[[
		...
		{field:"className",title:"教师账号",width:"20%",sort:true},
		{field:"classStatusText",title:"教师姓名",width:"50%",sort:true},
		{fixed: 'right', title: '操作', toolbar: '#examBar', width:"25%" ,unresize:true}
	]],
	url:"/api/getClassInExam",
	method:"POST",
